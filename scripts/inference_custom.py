...
from ltxv_trainer.custom.dinov3_proj_add.trainer import CustomTrainerConfig as LtxvTrainerConfig
from ltxv_trainer.custom.dinov3_proj_add.trainer import CustomTrainer as LtxvTrainer

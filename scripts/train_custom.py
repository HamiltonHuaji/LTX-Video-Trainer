...
from ltxv_trainer.custom.dinov3_proj_as_text.trainer import CustomTrainerConfig as LtxvTrainerConfig
from ltxv_trainer.custom.dinov3_proj_as_text.trainer import CustomTrainer as LtxvTrainer
